    ...
    <div className={classes.root}>
      ...
      <div className={classes.menu}>
        ...
        <div className>
          <Grid container>
            <Grid xs={12} sm={6}>
              <Link to="restaurante" className="linke">
            ...
            <Grid xs={12} sm={6}>
              <Link  className="linke">
              
            <Button onClick={()=> setModalIsOpen(true)} variant="contained" classes={{
          ...
          <Modal isOpen={modalIsOpen} className='modal' style={{overlay: { backgroundColor: '#282c34' } }}>
              <QRCode value={id} ></QRCode>
              <p className='pepe'>¡Este es el codigo de tu reserva!</p>
              <div>
              <Link to="recomendados"  className="linke">
                <Button onClick={()=> {console.log(id)}} variant="contained" classes={{ root: classes.buttonreserva, label: classes.label,  }}>
